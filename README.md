...
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v14/assets/sagepilot-hero-animated.gif
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v14/assets/sagepilot-mark-animated.gif

URLs are pinned to the immutable `v14` tag (jsDelivr caches mutable `@main`
refs unpredictably). After regenerating assets: commit + push, tag the new
release (`git tag v15 && git push origin v15`), update the tag in
