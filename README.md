...
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v9/assets/sagepilot-hero-animated.gif
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v9/assets/sagepilot-mark-animated.gif

URLs are pinned to the immutable `v9` tag (jsDelivr caches mutable `@main`
refs unpredictably). After regenerating assets: commit + push, tag the new
release (`git tag v10 && git push origin v10`), update the tag in
