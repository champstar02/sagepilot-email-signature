...
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v4/assets/sagepilot-hero-animated.gif
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v4/assets/sagepilot-mark-animated.gif

URLs are pinned to the immutable `v4` tag (jsDelivr caches mutable `@main`
refs unpredictably). After regenerating assets: commit + push, tag the new
release (`git tag v5 && git push origin v5`), update the tag in
