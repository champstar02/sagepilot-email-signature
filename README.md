...
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v18/assets/sagepilot-hero-animated.gif
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v18/assets/sagepilot-mark-animated.gif

URLs are pinned to the immutable `v18` tag (jsDelivr caches mutable `@main`
refs unpredictably). After regenerating assets: commit + push, tag the new
release (`git tag v19 && git push origin v19`), update the tag in
