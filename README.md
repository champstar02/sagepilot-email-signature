...
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v15/assets/sagepilot-hero-animated.gif
- https://cdn.jsdelivr.net/gh/champstar02/sagepilot-email-signature@v15/assets/sagepilot-mark-animated.gif

URLs are pinned to the immutable `v15` tag (jsDelivr caches mutable `@main`
refs unpredictably). After regenerating assets: commit + push, tag the new
release (`git tag v16 && git push origin v16`), update the tag in
